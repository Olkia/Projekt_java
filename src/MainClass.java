        ...
        while (!(Helper.isAnyWinner(players))) {
            ...
            for (int h = 0; h < numofplayers; h++) {
                ...
                if (!(actplayer.namedetected)) {
                    System.out.println("Witaj w świecie farmerów.\nBylibyśmy zaszczyceni mogąc poznać twe imie ");
                    System.out.print("Twoje imie : ");
                    actplayer.name = s.nextLine();
                    System.out.println("A więc witaj " + actplayer.name + "!\n Miło nam ciebie poznac !");
                    Helper.waitForEnter();
