...
public class Shop {
    ...
    public static void seedsShop(Player p, int flucts) {
        ...
        System.out.println("Twoje środki wynoszą " + p.money);
        System.out.println("1. Rukola  " + Arugula.plant_cost * (100 + flucts) / 100);
        ...
        System.out.println("6. Gruszka  " + Pear.plant_cost * (100 + flucts) / 100);
        System.out.println("7. Wyjdz ze sklepu ...");
        System.out.print("Twój wybór : ");
        choice = s.nextLine();
        System.out.println();
        switch (choice) {
            case "1" -> {
                if (p.money < Arugula.plant_cost * (100 + flucts) / 100) {
                    System.out.println("Nie masz wystarczającej ilości gotówki ... ");
                } else {
                    p.money -= Arugula.plant_cost * (100 + flucts) / 100;
                    p.plants.add(new Arugula());
                    System.out.println("Zakup przebiegł pomyślnie");
                    Helper.waitForEnter();
                }
            }
            ...
            case "6" -> {
                if (p.money < Pear.plant_cost * (100 + flucts) / 100) {
                    System.out.println("Nie masz wystarczającej ilości gotówki ... ");
                } else {
                    p.money -= Pear.plant_cost * (100 + flucts) / 100;
                    p.plants.add(new Pear());
                    System.out.println("Zakup przebiegł pomyślnie");
                    Helper.waitForEnter();
                }
            }
    ...
    public static void sellcrops(Player p, int flucts) {
        ...
        System.out.println("1. " + p.stash[0] + "kg Rukoli ( cena za kg - " + Arugula.sell_price * (100 + flucts) / 100 + " )");
        ...
        System.out.println("6. " + p.stash[5] + "kg Gruszek ( cena za kg - " + Pear.sell_price * (100 + flucts) / 100 + " )\"");
        System.out.println("7. Wyjdz ze sklepu ...");
        ...
        switch (choice) {
            case "1" -> {
                if (p.stash[0] < kgs) System.out.println("Nie masz wystarczającej ilości zapasów do sprzedaży");
                    ...
                    p.money += kgs * Arugula.sell_price * (100 + flucts) / 100;
                    p.stash[0] -= kgs;
                    p.warehouse_place += kgs;
                }
            }
            ...
            case "6" -> {
                if (p.stash[5] < kgs) System.out.println("Nie masz wystarczającej ilości zapasów do sprzedaży");
                    ...
                    p.money += kgs * Pear.sell_price * (100 + flucts) / 100;
                    p.stash[5] -= kgs;
                    p.warehouse_place += kgs;
                }
            }
